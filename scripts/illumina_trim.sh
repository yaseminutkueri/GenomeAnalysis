...
trimmomatic PE -phred33 ${read_dir}/* ${out_dir}/illumina_trimmed_paired_1.fq.gz ${out_dir}/illumina_trimmed_unpaired_1.fq.gz ${out_dir}/illumina_trimmed_paired_2.fq.gz ${out_dir}/illumina_trimmed_unpaired_2.fq.gz ILLUMINACLIP:TruSeq3-PE.fa:2:30:10:2:True LEADING:3 TRAILING:3 MINLEN:36